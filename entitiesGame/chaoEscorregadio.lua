...
function ChaoEscorregadio:new(x, y, automaticDraw)
    local imagePath = "assets/chao_escorregadio.png"
    local atravessavel = true
    ChaoEscorregadio.super.new(self, x, y, imagePath, World, ShapeTypes.RECTANGLE, BodyTypes.DYNAMIC, EntityTags.CHAO_ESCORREGADIO, atravessavel, automaticDraw)
end
